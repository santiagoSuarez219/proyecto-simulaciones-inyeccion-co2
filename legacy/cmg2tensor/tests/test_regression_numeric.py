...
from cmg2tensor.parse_txt import (
    GridShape,
...
from tests.conftest import NI, NJ, NZ, TIME_DAYS
...
def test_build_layer_cubes_shape(cmg_file, cmg_file_b):
    ...
    from cmg2tensor.parse_txt import build_layer_cubes
...
def test_build_single_variable_layer_cubes_shape(cmg_file):
    ...
    from cmg2tensor.parse_txt import build_single_variable_layer_cubes
...
def test_normalize_cubes_minmax_values_in_0_1(cmg_file):
    ...
    from cmg2tensor.parse_txt import build_layer_cubes
    from cmg2tensor.normalize import normalize_cubes_minmax
...
def test_normalize_cubes_with_global_stats(cmg_file):
    ...
    from cmg2tensor.parse_txt import build_layer_cubes
    from cmg2tensor.normalize import normalize_cubes_minmax, normalize_cubes_minmax_with_global_stats
    cubes, _ = build_layer_cubes(cmg_file, cmg_file, NZ, NJ, NI, return_times=True)
